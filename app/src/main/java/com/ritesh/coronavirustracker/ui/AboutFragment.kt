package com.ritesh.coronavirustracker.ui
...
import com.ritesh.coronavirustracker.R
...
class AboutFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val madeBy = SpannableString(
            "Made with ❤️.\n GitHub: github.com/DARK-art108/\n LinkedIn:linkedin.com/in/ritesh-yadav-a2a6a818b/\n\n\n©2020 Ritesh Yadav. All Rights Reserved"
        )
        val privacySpan: ClickableSpan = object : ClickableSpan() {
            override fun onClick(textView: View) {
                requireContext().openChrome("https://github.com/DARK-art108")
            }
        ...
        val tosSpan: ClickableSpan = object : ClickableSpan() {
            override fun onClick(textView: View) {
                requireContext().openChrome("https://linkedin.com/in/ritesh-yadav-a2a6a818b")
            }
